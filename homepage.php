...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./Styles/homepagestyles.css?v=1.0" />
  </head>
  <body>
    <nav id="nav-bar" class="navBar">
      ...
      <ul id="nav-links">
        ...
        <li class="nav-link"><a href="./homepage.php">About</a></li>
        <li class="nav-link"><a href="./homepage.php">Contact Us</a></li>
      </ul>
