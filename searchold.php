...
<body id="dashboard">
    ...
    <main>
        ...
        <form class="search-container">
            <div class="searchbar">
                <input type="search" placeholder="Search your registered customers">
        ...
        <section id="accounts">
            ...
            <div id="accounts-table">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="col1">Jeffrey</td>
                            <td class="col2">Fayokunmi</td>
                            <td class="col3">07012345679</td>
                            <td class="col4">M</td>
                            <td class="col5">No</td>
                            <td class="col6"><button class="view-details btn btn-sm btn-outline border-thick">View Details</button></td>
                        </tr>
                        <tr>
                            <td class="col1">Jeffrey</td>
                            <td class="col2">Fayokunmi</td>
                            ...
                            <td class="col4">M</td>
                            <td class="col5">No</td>
                            <td class="col6"><button class="view-details btn btn-sm btn-outline">View Details</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
